			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"><!--su-->
							<b class="caret"></b>
						</a>
	...
	<div class="container py-lg-5 py-3">
		...
		<div class="row service-grids">
			<div class="col-lg-4 col-md-6 service-grid1">
				<a href="application_form.php"><h3>Ramanadan</h3></a><!--su-->
				<div class="row">
			...
			<div class="col-lg-4 col-md-6 mt-md-0 mt-5 service-grid1">
				<a href="application_form.php"><h3>Ediriweera sarachchandra</h3></a>
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>2 yr</h4>
					</div>
			...
			<div class="col-lg-4 col-md-6 mt-lg-0 mt-5 service-grid1">
				<a href="application_form.php"><h3>Gunapala Malalasekara</h3></a><!--su-->
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>2 yr</h4>
					</div>
			...
			<div class="col-lg-4 col-md-6 mt-5 service-grid1">
				<a href="application_form.php"><h3>Wijewaradhana</h3></a><!--su-->
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>3 yr</h4>
					</div>
			...
			<div class="col-lg-4 col-md-6 mt-5 service-grid1">
				<a href="application_form.php"><h3>Hilda</h3></a><!--su-->
				<div class="row">
					<div class="col-md-3 col-2">
						<h4>4 yr</h4>
					</div>
				...
				<div class="row wthree_banner_bottom_right_grids pr-sm-3">
					<div class="col-lg-3 col-sm-6 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								...
								<h3> Apply for Ramanadan Hall</h3><!--su-->
								<p>Ramanadan Hall</p>
							</div>
							<div class="mask">
					...
					<div class="col-lg-3 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
						<div class="view view1 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Sarachchandara Hall</h3><!--su-->
								<p>Sarachchandara Hall</p>
							</div>
							<div class="mask">
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view2 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Gunapala Malalasekara hall</h3><!--su-->
								<p>Gunapala Malalasekara hall</p>
							</div>
							<div class="mask">
					...
					<div class="col-lg-3 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
						<div class="view view3 view-tenth">
							<div class="agile_text_box">
								<i class="fas fa-bed" aria-hidden="true"></i>
								<h3>Apply for Wijewardhana Hall</h3><!--su-->
								<p>Wijewardhana Hall</p>
							</div>
							<div class="mask">
